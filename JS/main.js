            ...
            data.forEach(item => {
                tbody.append(`
                 <tr data-id="${item.id}">
                    ...
                    <td class="btn-del" data-id="${item.id}"><img src="./img/iconfinder_free-09_463017.png"></td>
                    <td>
...
// tbody.on('click', '.item-info', (e) => {
//     let about = $(e.target).attr('data-about');
//     let text = $(e.target).text();
//     $(e.target).html(`    
//     <input class="edit-item-info" type="text" value="${text}"></input>
//     `);
// });

// tbody.on('change', '.edit-item-info', (e) => {
//     let target = $(e.target);
